...
class TimesheetOutputSummaryRegularHHMM extends Component {
  ...
  render() {
    ...
    return (
            <div className="summary-cell-values">
              ...
              {(() => {
                if (totalMinutesNumber > 0 && totalMinutesNumber < 40) {
                  return (
                    totalMinutes
                  )
                } else if (totalMinutesNumber > 0 && totalMinutesNumber >= 40) {
                  return (
                    '40:00')
                  } else {
                  return (
...
export default TimesheetOutputSummaryRegularHHMM;
